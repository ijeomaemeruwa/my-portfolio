...
const AboutSection = () => {
    ...
    <div className="col-md-10 mx-auto about_info text-left">
     ...
     part of an evolving community.  I am a full-stack JavaScript developer 
     who enjoys designing and developing software solutions that foster inclusive and optimized experiences. 
     </p>
     <p>
     ...
     <p>
     In my spare time, I enjoy listening to music, traveling, watching documentaries, 
     curating new recipes, and exploring restaurants.
     </p>
    </div>
    </div>
    </div>     
